...
const AdvancedLevelPassPaper = () => {
  const [passPapers, setPassPapers] = useState([]);

  useEffect(() => {
    axios
      .get("http://localhost:5000/api/advanced-level-pass")
  ...
  return (
    ...
    <h1 className="text-center mb-4" style={{ color: "#89590a", fontWeight: "bold" }}>
  Advanced Level Pass Papers
</h1>
  ...
  className="btn"
  style={{ backgroundColor: "#e6ae59", color: "#fff", border: "none" }} // Custom color
  target="_blank"
...
export default AdvancedLevelPassPaper;
